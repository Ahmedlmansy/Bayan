...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      name: t("E-Commerce_Platform"),
      des: t("desProject_one"),
      iconProject: (
        <svg
    ...
    {
      id: 2,
      name: t("Company_Portfolio_Website"),
      des: t("desProject_two"),
      iconProject: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#11b886"
    ...
    {
      id: 3,
      name: t("Mobile_App_Dashboard"),
      des: t("desProject_three"),
      iconProject: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#6950e8"
    ...
    {
      id: 4,
      name: t("Learning_Management_System"),
      des: t("desProject_four"),
      iconProject: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#febf06"
    ...
    {
      id: 5,
      name: t("Social_Media_App"),
      des: t("desProject_five"),
      iconProject: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#11b886"
    ...
    {
      id: 6,
      name: t("Freelance_Management_System"),
      des: t("desProject_six"),
      iconProject: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="#6950e8"
