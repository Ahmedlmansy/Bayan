...
export default function Header() {
  ...
  return (
    <div>
      <div className="row my-3 mx-0 headerStiky">
        <DrawerSaidbar />

        <div className="otherIcons col-10">
          ...
          {/* <div className="apps_service icon">
            ...
            >
              <path
                d="M6.875 5.1875C6.875 6.11914 6.11914 6.875 5.1875 6.875H1.8125C0.880508 6.875 0.125 6.11914 0.125 5.1875V1.8125C0.125 0.880508 0.880508 0.125 1.8125 0.125H5.1875C6.11914 0.125 6.875 0.880508 6.875 1.8125V5.1875ZM15.875 14.1875C15.875 15.1191 15.1191 15.875 14.1875 15.875H10.8125C9.88086 15.875 9.125 15.1191 9.125 14.1875V10.8125C9.125 9.88086 9.88086 9.125 10.8125 9.125H14.1875C15.1191 9.125 15.875 9.88086 15.875 10.8125V14.1875Z"
                fill="currentColor"
              ></path>
              <path
                opacity="0.4"
                d="M15.875 5.46875C15.875 6.2457 15.2457 6.875 14.4688 6.875H10.5312C9.7543 6.875 9.125 6.2457 9.125 5.46875V1.53125C9.125 0.754648 9.7543 0.125 10.5312 0.125H14.4688C15.2457 0.125 15.875 0.754648 15.875 1.53125V5.46875ZM6.875 14.4688C6.875 15.2457 6.2457 15.875 5.46875 15.875H1.53125C0.754648 15.875 0.125 15.2457 0.125 14.4688V10.5312C0.125 9.7543 0.754648 9.125 1.53125 9.125H5.46875C6.2457 9.125 6.875 9.7543 6.875 10.5312V14.4688Z"
                fill="currentColor"
              ></path>
            </svg>
          </div> */}
